...
class LeadRealisasiList extends StatefulWidget {
  ...
  final String token;
  const LeadRealisasiList(
      {required this.baseUrl, required this.token, super.key});
...
class _LeadRealisasiListState extends State<LeadRealisasiList> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      setState(() {
        items = res is List ? res : (res['data'] ?? res);
      });
    } catch (e) {
