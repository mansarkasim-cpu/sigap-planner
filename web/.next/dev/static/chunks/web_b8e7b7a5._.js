...
function VisTimelineGantt({ pageSize = 2000 }) {
    ...
    const [fullscreen, setFullscreen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
                ...
                timeline.on('select', {
                    "VisTimelineGantt.useEffect.mount": (props)=>{
                        ...
                        const row = items.find({
                            "VisTimelineGantt.useEffect.mount.row": (it)=>it.id === id
...
_s(VisTimelineGantt, "hadyVqd8AhmHTa/6w6pl8Vv2Elg=");
_c = VisTimelineGantt;
var _c;
...
//# sourceMappingURL=web_b8e7b7a5._.js.map