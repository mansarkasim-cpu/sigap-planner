...
var __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f40$mui$2f$icons$2d$material$2f$ZoomOut$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/web/node_modules/@mui/icons-material/ZoomOut.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f40$mui$2f$icons$2d$material$2f$ZoomIn$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/web/node_modules/@mui/icons-material/ZoomIn.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f40$mui$2f$icons$2d$material$2f$Refresh$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/web/node_modules/@mui/icons-material/Refresh.js [app-client] (ecmascript)");
...
function GanttChart({ pageSize = 2000 }) {
    ...
    const [displayMode, setDisplayMode] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('both');
        ...
        try {
            ...
            try {
                await Promise.all(mapped.map(async (m)=>{
                    try {
                        const rr = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(`/work-orders/${encodeURIComponent(String(m.id))}/realisasi`);
            ...
            if (("TURBOPACK compile-time value", "object") !== 'undefined' && window.console && window.console.debug) {
                console.debug('[Gantt] loaded items:', mapped.length, mapped.map((r)=>r.id ?? r.doc_no));
            }
            // detailed debug: show start/end values and parsed timestamps
            if (("TURBOPACK compile-time value", "object") !== 'undefined' && window.console && window.console.debug) {
                try {
                    console.debug('[Gantt] items details:', mapped.map((r)=>({
                            id: r.id ?? r.doc_no,
                            start_date: r.start_date,
                            end_date: r.end_date,
                            sMs: isoToMs(r.start_date),
                            eMs: isoToMs(r.end_date)
                        })));
                } catch (e) {}
            }
        } catch (err) {
    ...
    const validItems = (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "GanttChart.useMemo[validItems]": ()=>{
            ...
            if (("TURBOPACK compile-time value", "object") !== 'undefined' && window.console && window.console.debug) {
                try {
                    console.debug('[Gantt] filter reasons:', debugReasons);
                } catch (e) {}
            }
            return sorted;
        }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GanttChart.useEffect": ()=>{
            ...
            ;
            try {
                console.debug('[Gantt] validItems:', validItems.length, validItems.map({
                    "GanttChart.useEffect": (i)=>i.id ?? i.doc_no
                }["GanttChart.useEffect"]));
            } catch (e) {}
        }
    }["GanttChart.useEffect"], [
                                                        ...
                                                        (statusNorm === 'IN_PROGRESS' && progressVal !== null || statusNorm === 'COMPLETED') && (()=>{
                                                            ...
                                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                                                children: [
                                                                    ...
                                                                    progWidth > 28 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("text", {
                                                                        x: x1 + 6,
                                                                        ...
                                                                        lineNumber: 718,
                                                                        columnNumber: 35
                                                                    }, this) : /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("text", {
                                                                        x: x2 + 6,
                                                                        y: y + (rowHeight - 12) / 2 + 4,
                                                                        fontSize: 12,
                                                                        fill: color,
...
//# sourceMappingURL=web_components_GanttChart_tsx_99ef09d4._.js.map