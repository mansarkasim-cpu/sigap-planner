...
"[project]/web/components/VisTimelineGantt.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
// Warna berdasarkan status / type
function pickColor(w) {
    const wt = (w.work_type || w.raw?.work_type || w.raw?.type_work || '').toString().toLowerCase();
    const status = (w.raw?.doc_status || '').toLowerCase();
...
function VisTimelineGantt({ pageSize = 2000 }) {
    ...
    const tlRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(null);
    const customNowIdRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    const [fullscreen, setFullscreen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    // inject vis-timeline CSS sekali
    ...
    function buildDayData(dateStr) {
        ...
        const groups = filtered.map((it)=>({
                id: String(it.id),
                content: `${it.doc_no} — ${it.asset_name}`
            }));
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        async function mount() {
            ...
            const { groups, items, dayStart, dayEnd } = buildDayData(selectedDate);
            ...
            // Pewarnaan item
            items.forEach((it)=>{
                const color = pickColor(it._raw);
                addCssRule(`.vis-item.wo-${it.id} .vis-item-content`, `background:${color}!important;color:#fff;border-radius:4px;`);
            });
            // Click listener
    ...
    function addCssRule(selector, rule) {
        const styleId = 'vis-dynamic-style';
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "jsx-28d5232307f76530" + " " + ((fullscreen ? 'gantt-fullscreen' : '') || ""),
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "jsx-28d5232307f76530" + " " + "gantt-wrapper",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "jsx-28d5232307f76530" + " " + "gantt-toolbar",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                                className: "jsx-28d5232307f76530",
                                children: "Work Order Gantt"
                            }, void 0, false, {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "jsx-28d5232307f76530" + " " + "toolbar-right",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                        ...
                                        className: "jsx-28d5232307f76530" + " " + "date-input"
                                    }, void 0, false, {
                                        fileName: "[project]/web/components/VisTimelineGantt.tsx",
                                        lineNumber: 245,
                                        columnNumber: 13
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        onClick: ()=>load(),
                                        className: "jsx-28d5232307f76530" + " " + "btn small",
                                        children: "Refresh"
                                    }, void 0, false, {
                                        fileName: "[project]/web/components/VisTimelineGantt.tsx",
                                        lineNumber: 252,
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        className: "jsx-28d5232307f76530" + " " + "btn small blue",
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ref: containerRef,
                        className: "jsx-28d5232307f76530" + " " + "gantt-container"
                    }, void 0, false, {
                        fileName: "[project]/web/components/VisTimelineGantt.tsx",
                        lineNumber: 263,
                        columnNumber: 9
                    ...
                    selected && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "jsx-28d5232307f76530" + " " + "modal-overlay",
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "jsx-28d5232307f76530" + " " + "modal-card",
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("pre", {
                                    className: "jsx-28d5232307f76530" + " " + "modal-json",
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    ...
                                    className: "jsx-28d5232307f76530" + " " + "btn",
                                    children: "Close"
                                }, void 0, false, {
                                    fileName: "[project]/web/components/VisTimelineGantt.tsx",
                                    lineNumber: 287,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$styled$2d$jsx$2f$style$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                id: "28d5232307f76530",
                children: ".gantt-wrapper.jsx-28d5232307f76530{background:#fff;border-radius:12px;padding:16px;box-shadow:0 4px 14px #0000001a}.gantt-toolbar.jsx-28d5232307f76530{justify-content:space-between;align-items:center;margin-bottom:12px;display:flex}.toolbar-right.jsx-28d5232307f76530{align-items:center;gap:10px;display:flex}.date-input.jsx-28d5232307f76530{border:1px solid #ddd;border-radius:6px;padding:6px 10px}.btn.jsx-28d5232307f76530{cursor:pointer;color:#fff;background:#444;border:none;border-radius:6px;padding:6px 12px}.btn.small.jsx-28d5232307f76530{font-size:.8rem}.btn.blue.jsx-28d5232307f76530{background:#2563eb}.gantt-container.jsx-28d5232307f76530{height:500px}.gantt-fullscreen.jsx-28d5232307f76530{z-index:99999;background:#fff;width:100vw;height:100vh;padding:20px;position:fixed;top:0;left:0;overflow:auto}.modal-overlay.jsx-28d5232307f76530{z-index:99999;background:#00000073;justify-content:center;align-items:center;width:100vw;height:100vh;display:flex;position:fixed;top:0;left:0}.modal-card.jsx-28d5232307f76530{background:#fff;border-radius:10px;width:700px;max-height:80vh;padding:20px;overflow-y:auto;box-shadow:0 4px 14px #00000040}.modal-json.jsx-28d5232307f76530{white-space:pre-wrap;background:#f7f7f7;border-radius:8px;margin-top:10px;padding:10px}"
...
//# sourceMappingURL=web_a6cba8c5._.js.map