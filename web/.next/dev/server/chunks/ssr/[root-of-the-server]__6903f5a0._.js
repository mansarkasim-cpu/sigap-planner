...
function LoginPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (("TURBOPACK compile-time value", "undefined") !== 'undefined' && localStorage.getItem('sigap_auth')) //TURBOPACK unreachable
        ;
    }, [
        router
    ]);
    function handleSubmit(e) {
        ...
        // simple client-side fake auth
        localStorage.setItem('sigap_auth', 'true');
        localStorage.setItem('sigap_user', email);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6903f5a0._.js.map